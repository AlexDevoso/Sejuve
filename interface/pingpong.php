...
//selecionando id da modalidade
$mostrarModalidade = "SELECT modalidade_individualid from modalidade_individual where nome_mi = 'pingpong'";
$reModalidade = mysqli_query($conexao, $mostrarModalidade);
$linhasModalidade = mysqli_fetch_row($reModalidade);
$idModalidade = implode($linhasModalidade);
?>
...
body {
  ...
  background: url(../imagens/ping5.jpg) no-repeat center center fixed; 
...
<script type="text/javascript">
  ...
  <div class="d-flex" id="wrapper">
    ...
    <!-- Sidebar -->
    <div class="" id="sidebar-wrapper" style="background-color:#800000;">
...
<img width="70" src="../imagens/cards/ping_c.png" style="margin-right: 20px;">
