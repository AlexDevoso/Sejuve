...
<center><h1>Cadastrar Alunos - Jogos Escolares</h1></center>
...
<form action="cadastrar_aluno_jogos.php" enctype="multipart/form-data" method="POST" style="margin-left: auto !important;margin-right: auto !important;"> 
    <table style="">
