...
<!--FOLHA DE ESTILO-->
<link rel="stylesheet" type="text/css" href="../css/style_editar_escola.css">
...
<center><h1 style="margin: 20px;">Editar Escola - Nome da Escola</h1></center>




<div class="centralizar_bg">
...
<button  type="submit" name="cadastrar" class="btn btn-success" style="float: right;border-radius: 50px;width:170px;margin-top:20px; " >Salvar</button>
<!-- FECHA O BTN DO FORM-->
